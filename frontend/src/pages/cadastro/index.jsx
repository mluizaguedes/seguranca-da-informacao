  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-8 bg-white border border-gray-100 rounded-lg shadow-lg">
      ...
      <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
        ...
        <div className="space-y-4 mt-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">
                  Quero receber novidades e avisos por e-mail (Opcional)
                </p>
                <p className="text-sm text-gray-600">
                  Ao marcar esta opção, você autoriza o envio de novidades,
                  atualizações e comunicados por e-mail. Isso nos ajuda a
                  mantê-lo informado sobre oportunidades e eventos importantes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-200 rounded-md p-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">
                  Autorizo o compartilhamento dos meus dados com parceiros
                  educacionais (Opcional)
                </p>
                <p className="text-sm text-gray-600">
                  Permite que seus dados sejam compartilhados com instituições
                  parceiras com o objetivo de oferecer conteúdos ou benefícios
                  educacionais. Esta permissão é totalmente opcional e revogável
                  a qualquer momento.
                </p>
              </div>
            </div>
        ...
        <button className="w-full bg-gray-300/100 py-2 px-4 rounded-md hover:bg-gray-200">
          Cadastrar-se
        </button>
      </form>
